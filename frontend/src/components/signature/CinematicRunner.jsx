      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-2xl px-4">
        ...
        <div className="relative mb-12 flex justify-center">
          ...
          <div
            ...
            style={{
              ...
              transform: ["INITIATING", "SPINNING"].includes(phase)
          ...
          <div
            ...
            style={{
              ...
              filter:
                phase === "FLASH"
                  ? `brightness(2) drop-shadow(0 0 50px ${color})`
        ...
        <div
          ...
          style={{
            ...
            transform: ["TEXT_FADE_IN", "IDLE"].includes(phase)
              ? "translateY(0)"
              : "translateY(20px)",
          }}
        >
          ...
          {xp_bonus > 0 && (
            <div
              className="inline-block mt-6 px-6 py-2 rounded-full border bg-zinc-900 shadow-lg"
              style={{

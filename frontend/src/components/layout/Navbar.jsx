        ...
        <nav className="fixed top-0 left-0 right-0 z-40 flex h-16 shrink-0 items-center justify-between border-b border-border bg-background/80 backdrop-blur-md px-4 sm:px-6">
            ...
            <div className="flex items-center gap-4 sm:gap-6">
                ...
                {user && (
                    <div className="flex items-center gap-3 pr-4 border-r border-border">
                        <div className="hidden sm:flex flex-col items-end">
                            <span className="text-xs font-semibold" style={{ color: rank?.color || '#a1a1aa' }}>
                                {rank?.name || 'Trainee'}
                            </span>
                        ...
                        <div className="flex items-center gap-1 bg-secondary rounded-full px-3 py-1 border border-border">
                            <span className="text-xs font-bold text-white"><XPCounter value={user?.xp || 0} /></span>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button variant="ghost" size="icon" onClick={handleLogout} className="text-zinc-400 hover:text-white" title="Logout">

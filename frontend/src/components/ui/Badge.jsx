...
const variants = {
    ...
    success: "bg-[rgba(16,185,129,0.1)] text-success border border-[rgba(16,185,129,0.2)]",
    warning: "bg-[rgba(245,158,11,0.1)] text-warning border border-[rgba(245,158,11,0.2)]",
    danger: "bg-[rgba(239,68,68,0.1)] text-danger border border-[rgba(239,68,68,0.2)]",
    ...
    vision: "bg-[rgba(0,255,136,0.1)] text-[#00ff88] border border-[rgba(0,255,136,0.2)]",
    agents: "bg-[rgba(255,170,0,0.1)] text-[#ffaa00] border border-[rgba(255,170,0,0.2)]",
};
